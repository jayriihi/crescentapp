...
def get_tide_data_for_session(datetimelocal_str,duration_str):
    ...
    #print(flow_state_beg, flow_state_end , prev_peak_time, prev_peak_state, next_peak_time, next_peak_state, sesh_start_datetime, sesh_end_time)
    return(flow_state_beg, flow_state_end , prev_peak_time, prev_peak_state, next_peak_time, next_peak_state)

#get_tide_data_for_session('2022-11-28T15:00','2:0')
